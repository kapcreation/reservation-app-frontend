    ...
    <div className='min-h-[80vh]'>
      <div className="container mx-auto px-4">
        <div className='max-w-xl mx-auto text-center mt-8'>
          <img src={smile} alt="" className='inline-block w-16 h-16 object-contain mb-1' />
          <h1 className='font-bold text-2xl text-slate-900 mb-1'>Congratulations on booking your hotel!</h1>
          ...
          <Link to="/" className='bg-primary text-white font-semibold py-2 px-4 rounded-md'>Hey, That's great!</Link>
        </div>
      </div>
    </div>
  )
